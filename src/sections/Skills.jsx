                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-3 pb-3 border-b border-slate-700/50">
                                    <div className="w-10 h-10 bg-emerald-500/10 rounded-lg flex items-center justify-center group-hover:bg-emerald-500/20 transition-colors flex-shrink-0">
                                        ...
                                        {group.category.includes("Backend") && (
                                            <svg className="w-6 h-6 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        {group.category.includes("Systems") && (
                                            <svg className="w-6 h-6 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" />
                                            </svg>
                                        )}

                                        {!["Languages", "Databases", "Frameworks"].includes(group.category) && !group.category.includes("Backend") && !group.category.includes("Systems") && (
                                            <svg className="w-6 h-6 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
