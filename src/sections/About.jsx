        ...
        >
            ...
            <div className="relative z-10 max-w-6xl mx-auto">
                ...
                <div className="grid lg:grid-cols-2 gap-10 items-stretch">
                    {/* Description */}
                    <div className="space-y-8 bg-slate-900/40 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
                        <div className="space-y-4">
                            {/*<p className="text-sm font-medium uppercase tracking-[0.2em] text-slate-400">*/}
                            {/*    About*/}
                            {/*</p>*/}
                            <h3 className="text-2xl md:text-3xl font-semibold text-white">
                                Building reliable backend systems with modern tooling.
                            </h3>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6">
                            {about.stats?.map((stat) => (
                                <div
                                    key={stat.label}
                                    className="text-center p-4 bg-slate-900/60 border border-white/5 rounded-xl"
                                >
                    ...
                    <div className="bg-slate-900/40 border border-white/5 rounded-2xl p-8 backdrop-blur-sm">
                        <div className="grid sm:grid-cols-2 gap-4">
                            {about.highlights.map((item, index) => (
                                <div
                                    key={index}
                                    className="group relative bg-slate-900/50 border border-white/5 rounded-2xl p-6 hover:border-blue-500/30 transition-all duration-300"
                                    style={{
