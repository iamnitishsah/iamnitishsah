        ...
        <footer className="bg-slate-950 text-white border-t border-slate-800/50">
            <div className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-3 gap-10">
                ...
                <div>
                    ...
                    <a
                        href="/resume.pdf"
                        className="inline-block mt-6 px-5 py-2 rounded-lg bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-sm font-semibold shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/40 hover:scale-105 transition-all"
                    >
                        Download Resume
                    </a>
                </div>
            ...
            {/* BOTTOM BAR */}
            <div className="border-t border-slate-800/50 text-center py-6 text-sm text-slate-400">
